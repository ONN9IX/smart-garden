...
Перед первой задачей оба разработчика обязаны прочитать `docs/00-development-guide.md` и `docs/03-api-contract-v0.1.md`.
...
- `docs/06-product-scope.md` — зафиксированные границы продукта и ролей.\n- `docs/07-project-master-draft.md` — полная черновая память проекта: история идеи, все основные решения, изменённые решения, бизнес-контекст и технический контекст.
